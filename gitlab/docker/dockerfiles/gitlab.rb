...
# these settings do not work but figured out how to get into the gitlab admin account
gitlab_rails['gitlab_email_from'] = 'osapa.london@gmail.com'
gitlab_rails['gitlab_email_reply_to'] = 'osapa.london@gmail.com'

gitlab_rails['smtp_enable'] = true
gitlab_rails['smtp_address'] = "smtp.gmail.com"
gitlab_rails['smtp_port'] = 587
gitlab_rails['smtp_user_name'] = "osapa.london@gmail.com"
gitlab_rails['smtp_password'] = "12345678910"
